package com.example.filmolog.Model;

public class VideoUploadDetails {
    String video_slide,video_type,video_thumb,video_url,video_isim,video_aciklama,video_kategori,video_oyuncu,video_yonetmen,video_imdb;

    public VideoUploadDetails(String video_slide, String video_type, String video_thumb, String video_url, String video_isim, String video_aciklama, String video_kategori,String video_oyuncu,String video_yonetmen,String video_imdb) {
    ...
    public String getVideo_oyuncu() {
        return video_oyuncu;
    }

    public void setVideo_oyuncu(String video_oyuncu) {
        this.video_oyuncu = video_oyuncu;
    }

    public String getVideo_yonetmen() {
        return video_yonetmen;
    }

    public void setVideo_yonetmen(String video_yonetmen) {
        this.video_yonetmen = video_yonetmen;
    }
